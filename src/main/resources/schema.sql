...
CREATE TABLE IF NOT EXISTS USERS_NOTIFICATION (
                                         ...
                                         USER_NOTIFICATION_FLAG BOOLEAN NOT NULL DEFAULT FALSE,
                                         DISABLE_TIME TIMESTAMP NOT NULL
);

ALTER TABLE USERS_NOTIFICATION ADD CONSTRAINT FK_USERS_NOTIFICATION
    FOREIGN KEY (ID_USER)
        REFERENCES USERS (ID);
